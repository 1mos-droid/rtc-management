  ...
  return (
    <Box>
      ...
      {loading ? (
        ...
        <Paper elevation={0} sx={{ p: 10, textAlign: 'center', borderRadius: '24px', bgcolor: alpha(theme.palette.text.primary, 0.02), border: `1px solid ${theme.palette.divider}` }}>
            ...
            <Grid key={leader.id} xs={12} sm={6} md={4} lg={3}>
              ...
              >
                <Box sx={{ pt: 3, textAlign: 'center' }}>
                  ...
                  <Typography variant="caption" color="secondary.main" fontWeight={800} sx={{ textTransform: 'uppercase', letterSpacing: 1, display: 'inline-block', bgcolor: alpha(theme.palette.secondary.main, 0.1), px: 1, py: 0.5, borderRadius: '12px', mt: 0.5 }}>
